...
.quick-action.sim-btn {
  background: rgba(42, 167, 164, 0.15);
  border-color: rgba(42, 167, 164, 0.35);
  color: #6ee7d7;
}

.quick-action.sim-btn:hover {
  background: rgba(42, 167, 164, 0.28);
  border-color: rgba(42, 167, 164, 0.6);
  color: #a2f5e8;
}
